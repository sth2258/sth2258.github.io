						...
						<div id="content">
							...
							<!-- Content -->
								<article id="ourbackground">
									...
									<form action="accounts.html" method="post" id="form1">
									  Name: <input type="text" name="name" required>
									  E-Mail: <input type="email" name="email" required>
									  Phone Number: <input type="text" name="phone" required>
									  <input type="radio" name="acctType" value="corporate" checked> Corporate Account<br />
									  <input type="radio" name="acctType" value="personal"> Personal Account<br />
